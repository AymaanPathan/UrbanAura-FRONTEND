  ...
  return (
    <div className="collection-div" >
      ...
      <div className="main mt-8">
        ...
        <span className="border-b-2 border-yellow-400   md:font-extralight  md:font-sans md:text-center font-playfair-display  md:ml-2  md:text-4xl text-4xl text-green-950 text-center ">New Arrival</span>
        </div>
